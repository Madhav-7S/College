...
public class Result1 extends JFrame
{
	...
	public JButton jButton1,saveButton;
	...
	private void initializeComponent()
	{
		...
		addComponent(contentPane, saveButton, 540,570,83,35);
		
		this.setTitle("Result 1");
	...
	try{
		...
		int n=dlg.showSaveDialog(this);
		if(n==JFileChooser.APPROVE_OPTION)
		{
			BufferedOutputStream out=new BufferedOutputStream(new FileOutputStream(dlg.getSelectedFile()));
